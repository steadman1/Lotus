...
//  ?
//
//  Created by Peter Schoron on 09/20/2020.
//
...
final class Spotify: ObservableObject {
    ...
    let loginCallbackURL = URL(
        string: "lotus-for-spotify://spotify-login-callback"
    )!
    ...
    let keychain = Keychain(service: "com.spence.Lotus")
    ...
    /**
     ...
     `LoginView`.
     */
    func fetchAuthorizationURL() -> URL {
        guard let url = self.authorizationURL else {
