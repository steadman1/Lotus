...
public extension UIImage {
    ...
    /**
     ...
     - parameter type: profile image boundary is 50, track is 120
     
     - returns: thumb image
     */
    func wxCompress(type: WechatCompressType = .track) -> Data {
